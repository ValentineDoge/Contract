...
contract ValentineDoge is IBEP20, Auth {
  ...
  string constant _name = "ValentineDoge";
  string constant _symbol = "VDOGE";
  ...
  uint256 public sellMultiplier = 115;
  ...
  uint256 public _maxTxAmount = rSupply.div(1000).mul(1000);
  uint256 public _maxWalletToken = rSupply.div(1000).mul(1000);
  ...
  constructor() Auth(msg.sender) {
    ...
    marketingFeeReceiver = 0xB10A83Ab8fdd7F9eaE91f9114E2B4F186b7229Cd;
    devFeeReceiver = 0xbdf10767f9585C1aD35ad58C79F5cB39ca4911cF;
